...
> **Status: in development.** Tickbox is being extracted from the notepad in
> [Smart Toolkit](https://github.com/TheAmericanMaker/Smart-Toolkit) into a standalone app.
> Not yet released — see [CHANGELOG.md](CHANGELOG.md) once 1.0 lands.
...
- Photo attachments with on-device text extraction
